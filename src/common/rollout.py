...
class RolloutWorker:
    def __init__(self, env, agents, args):
        self.env = env
        self.agents = agents
        self.episode_limit = args.episode_limit  # 60
        self.n_actions = args.n_actions
        self.n_agents = args.n_agents
        self.state_shape = args.state_shape  # 48
        self.obs_shape = args.obs_shape  # 30
        self.args = args
    ...
    def generate_episode(self, episode_num=None, evaluate=False,epsilon=0):
        ...
        for key in episode.keys():
            episode[key] = np.array([episode[key]]) # (1, 60, 3, 30) (1, 60, 48) ...
        if not evaluate:
